...
@include('admin.pages.barang.cardnavigasibarang')
    @can('isAdmin')
        <h2 class="mb-5">Data Barang yang boleh dipinjam</h2>
    @endcan
    @can('isUser')
    ...
    @endif
    @can('isAdmin')
    <form action="/admin/tambahbarangpinjam" method="post">
        @csrf
    ...
    <tr>
        ...
        <td>
        <form action="/admin/barangpinjam/{{ $item->id }}" method="post" class="d-inline">
            @csrf
