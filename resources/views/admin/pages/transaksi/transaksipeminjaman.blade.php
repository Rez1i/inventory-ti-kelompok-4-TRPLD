    ...
    <form method="post" action="/admin/transaksi" enctype="multipart/form-data">
        ...
        <div class="width-75">
            ...
            <div class="mb-3">
                ...
                <input type="datetime-local" class="form-control @error('bataswaktu') is-invalid @enderror" id="datetime" name="bataswaktu" required>
                @error('bataswaktu')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
        </div>
