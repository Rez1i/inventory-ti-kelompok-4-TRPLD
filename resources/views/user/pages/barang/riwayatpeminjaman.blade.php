            ...
            <div class="container-fluid py-5 mt-5">
                <div class="container">
                    <div class="text-center">
                        <h2 class="welcome-title mb-4">Riwayat Peminjaman</h2>
                        <div class="mt-4 mb-4">
                            <br>
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        @if ($item->sarankomentar == '-')
                                            <td>
                                                <b><a href="/sarankomentar/{{ $item->id }}" class="link">Tambah
                                                        Komentar atau Saran</a></b>
                                            </td>
                                        @else
                    ...
                    @else
                    <h3 class="text-center">Anda Tidak Memiliki Riwayat Peminjaman</h3>
                    @endif
                </div>
            </div>
            </div>
